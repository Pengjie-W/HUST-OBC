...
"""### Set arguments"""
# nohup python -u 训练多.py > 训练多.log 2>&1 &
# kill 10985
parser = argparse.ArgumentParser(description='Train on CASIA-WebFace')
...
# utils
parser.add_argument('--resume', default='model3plusplus/model_last.pth', type=str, metavar='PATH', help='path to latest checkpoint (default: none)')
parser.add_argument('--results-dir', default='model3plusplus', type=str, metavar='PATH', help='path to cache (default: none)')
...
# b6 = nn.Sequential(*resnet_block(2048, 1024, 4096, 3, 2))
# b7 = nn.Sequential(*resnet_block(4096, 2048, 8192, 3, 2))
# b8 = nn.Sequential(*resnet_block(8192, 4096, 32768, 3, 2))
# b9 = nn.Sequential(*resnet_block(16384,8192, 32768, 1,1))
